...
Después se presentan los objetivos del trabajo y se define el planteamiento metodológico general. El desarrollo específico se estructura en tres capítulos principales. El Capítulo 4 describe con detalle el experimento realizado: datos utilizados, preparación de la información, modelos comparados, métricas, protocolo de evaluación y controles de reproducibilidad. El Capítulo 5 recoge los resultados obtenidos de forma descriptiva, mediante tablas y comparaciones objetivas entre baselines clásicos, VAE y TimeGAN. Finalmente, el Capítulo 6 discute el significado de esos resultados, sus limitaciones y las posibles líneas de trabajo futuro.
