...
La Figura~\ref{fig:diversificacion-teorica}, ya introducida en el marco teórico, muestra que el riesgo total disminuye conforme aumenta el número de activos en la cartera. Sin embargo, esta reducción tiene un límite asociado al riesgo sistemático o de mercado, que no puede eliminarse mediante diversificación.
