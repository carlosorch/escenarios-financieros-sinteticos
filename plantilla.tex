...
Con el desarrollo computacional, comenzaron a aplicarse técnicas de aprendizaje automático y modelos generativos, como los autoencoders variacionales (VAE) \cite{Kingma2013} y TimeGAN \cite{Yoon2019}, capaces de generar escenarios sintéticos de mercado y representar mejor la incertidumbre financiera. Paralelamente, la teoría de la información introdujo métricas como la entropía y la información mutua para analizar dependencias complejas entre activos.

La evolución de estos enfoques puede resumirse en la siguiente figura.
...
Asimismo, la información mutua permite capturar dependencias no lineales entre activos financieros, superando las limitaciones de la correlación lineal tradicional. Estas herramientas facilitan la construcción de carteras más diversificadas y adaptadas a la complejidad de los mercados \cite{Novais2022}.

La integración entre teoría de la información y modelos generativos resulta especialmente relevante en enfoques modernos de optimización de carteras. Modelos como los autoencoders variacionales incorporan explícitamente métricas informacionales dentro de su proceso de aprendizaje, permitiendo generar escenarios probabilísticos coherentes y evaluar rigurosamente su calidad.

El funcionamiento general de este tipo de enfoques puede representarse de forma esquemática en la siguiente figura.
...
Como muestra la Figura~\ref{fig:modelo}, estos modelos permiten aprender la distribución de los datos financieros históricos para posteriormente generar escenarios sintéticos coherentes con el comportamiento observado, mejorando así el análisis de riesgo y la optimización de carteras.
