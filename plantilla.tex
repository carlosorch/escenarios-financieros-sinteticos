...
En la evaluación multi-semilla, TimeGAN muestra resultados competitivos en algunas configuraciones, pero también una variabilidad apreciable entre ejecuciones. La variante sin calibrar usada para mínima varianza alcanza un Sharpe medio de 1,22, con desviación típica de 0,55. La variante calibrada a media y volatilidad para mínima varianza obtiene un Sharpe medio de 1,09, con desviación típica de 0,57. La cartera con media histórica contraída y covarianza sintética calibrada llega a 1,13, con desviación típica de 0,66. Por tanto, estos valores no deberían leerse solo por la media: la dispersión forma parte del resultado.
...
En conjunto, los resultados muestran que el pipeline permite comparar carteras clásicas, variantes robustas y carteras derivadas de escenarios sintéticos bajo un mismo protocolo. Las referencias clásicas siguen siendo sólidas. TimeGAN alcanza resultados competitivos en algunas configuraciones, pero la parte distribucional todavía deja margen claro de mejora. Para cerrar el análisis con una visión más completa, sigue siendo necesaria una comparación homogénea con VAE y una tabla distribucional más amplia.
