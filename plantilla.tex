...
Después se presentan los objetivos del trabajo y se define el planteamiento metodológico general. El Capítulo 4 establece el enfoque metodológico, los criterios generales de evaluación y la lógica de separación entre entrenamiento, validación y prueba. A continuación, el Capítulo 5 desarrolla de forma operativa la contribución: describe el experimento realizado, los datos utilizados, la preparación de la información, los modelos comparados, las métricas, el protocolo de reproducibilidad y los resultados obtenidos. Finalmente, el Capítulo 6 discute el significado de esos resultados, sus limitaciones y las posibles líneas de trabajo futuro.
...
Este capítulo cumple una función de encuadre metodológico. La descripción técnica completa del experimento se desarrolla en el Capítulo 5 para mantener separadas la justificación metodológica general, la ejecución concreta del pipeline y la interpretación posterior de los resultados.
...
El experimento compara tres familias de técnicas: baselines clásicos de cartera, un Autoencoder Variacional y TimeGAN. Esta organización permite distinguir entre métodos financieros consolidados y modelos generativos utilizados como generadores de escenarios sintéticos.
...
El VAE se utiliza como modelo generativo probabilístico basado en espacio latente. Su arquitectura combina un encoder, una representación latente, el mecanismo de reparametrización y un decoder. La función de pérdida incorpora un término de reconstrucción y una regularización KL, ponderada mediante distintos valores de \texttt{beta}. En la configuración experimental se consideran los valores 0,0, 0,00001, 0,0001 y 0,001. Su papel en el estudio consiste en aprender una representación comprimida de las ventanas históricas de retornos y generar nuevas muestras sintéticas a partir de ese espacio latente.

TimeGAN se utiliza como modelo generativo secuencial para series temporales financieras. Su interés dentro del trabajo radica en que, a diferencia de un modelo que trate cada ventana de forma más agregada, está diseñado para generar secuencias y preservar cierta dinámica temporal. En el experimento se evalúa con varias semillas, concretamente 42, 43, 44, 45 y 46, ya que el entrenamiento adversarial puede ser sensible a la inicialización y a la propia dinámica estocástica del proceso de aprendizaje. La selección de configuraciones debe apoyarse en métricas de validación y no en el rendimiento final sobre el conjunto de test, evitando así un sesgo por selección a posteriori.
...
\subsection{Fidelidad distribucional y limitaciones}
...
Los resultados obtenidos permiten analizar el papel de los modelos generativos dentro del problema de optimización de carteras desde una perspectiva prudente. El experimento no muestra que VAE o TimeGAN deban sustituir a los enfoques clásicos, pero sí permite estudiar en qué condiciones los escenarios sintéticos pueden aportar información útil y qué riesgos aparecen cuando se utilizan modelos generativos en series financieras.
...
El VAE, por su parte, cumple el papel de modelo generativo probabilístico basado en una representación latente. Su interés está en proporcionar una forma relativamente estable de generar escenarios sintéticos, aunque puede tener dificultades para reproducir fenómenos financieros extremos o dependencias temporales complejas. Este comportamiento es coherente con una limitación habitual de este tipo de modelos: al aprender una representación comprimida, pueden suavizar parte de la distribución y reproducir peor eventos de cola o cambios bruscos de volatilidad.
