...
La Figura~\ref{fig:frontera_eficiente} ilustra esta relación entre riesgo y retorno esperado. La curva superior recoge las combinaciones eficientes, mientras que las carteras situadas por debajo quedan dominadas por alternativas con mejor equilibrio entre rentabilidad y riesgo. De este modo, la figura permite visualizar el criterio de decisión del enfoque media-varianza sin repetir la definición ya introducida.
...
En el contexto financiero, estos modelos ofrecen la posibilidad de generar escenarios sintéticos del comportamiento del mercado. En esta línea, trabajos como el de \citeA{Mariani2019} han explorado el uso de modelos generativos en el análisis de carteras, mostrando su potencial como herramienta complementaria para estudiar la incertidumbre y el riesgo.
